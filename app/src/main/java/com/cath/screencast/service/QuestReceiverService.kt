...
import com.cath.screencast.decoder.AudioDecoder
import com.cath.screencast.decoder.VideoDecoder
import com.cath.screencast.model.StreamStats
import com.cath.screencast.model.TransportProtocol
import com.cath.screencast.net.IReceiver
import com.cath.screencast.net.LanDiscovery
import com.cath.screencast.net.TcpReceiver
import com.cath.screencast.net.UdpFecReceiver
...
class QuestReceiverService : Service() {
    ...
    fun startListening(
        ...
        if (isRecordEnabled) {
            try {
                val mgr = com.cath.screencast.encoder.MuxerManager(
                    context = this,
                    codecName = "Receiver",
                    expectAudio = true
                )
    ...
    fun stopListening() {
        ...
        onStatsUpdated?.invoke(com.cath.screencast.model.StreamStats())
